...
(function ($) {
  jQuery(document).ready(function () {
    ...
    jQuery("sidebar li.has-menu > a ").attr("href", "javascript:;"); // mobile multilevel menu
    ...
    $('#portfolio-slider [data-fancybox="gallery"]').fancybox(); //$('#top-cta .features-list .feature-box h3').matchHeight();
    // Read More Read Less
