<div class="quote-form">
    <div class="quote-form-in">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="q1-tab" data-toggle="tab" href="#q1" role="tab" aria-controls="q1" aria-selected="true"><i class="fal fa-home"></i><span>Home</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="q2-tab" data-toggle="tab" href="#q2" role="tab" aria-controls="q2" aria-selected="false"><i class="fal fa-car"></i> <span>Auto</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="q3-tab" data-toggle="tab" href="#q3" role="tab" aria-controls="q3" aria-selected="false"><i class="fal fa-car-garage"></i><span>Both</span></a>
            </li>
        </ul>
        <!-- Tab panes -->
