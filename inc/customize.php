...
function remove_footer_admin () {
    echo "West Coast East Coast Movers";
} 
...
#adminmenu div.wp-menu-name {
    border-bottom:1px dotted #3c4249!important;
}
